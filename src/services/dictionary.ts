...
function registerAllTools(store: DictionaryStore, paginationLimits: PaginationLimitsConfig | undefined) {
  ...
  const addExpressionSchema: any = {
    ...
    regex_pattern: z.string().optional().describe("Custom regex pattern evaluated by NodeJS RegExp. Do NOT wrap in slashes /.../ or append flags. Default matches term."),
    is_case_insensitive: z.boolean().optional().default(true).describe("Whether matching is case-insensitive. Configures the JS RegExp 'i' flag under the hood."),
    tags: tagsSchema,
  ...
  const editExpressionSchema: any = {
    ...
    regex_pattern: z.string().optional().describe("New custom regex pattern evaluated by NodeJS RegExp. Do NOT wrap in slashes /.../ or append flags."),
    is_case_insensitive: z.boolean().optional().describe("New case insensitivity setting configuring the JS RegExp 'i' flag."),
    tags: tagsSchema,
