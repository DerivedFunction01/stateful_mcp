...
export interface VariableStore {
  save(sessionId: string, key: string, value: unknown, blockInstanceId?: string): Promise<void>;
  saveBatch(sessionId: string, variables: Record<string, unknown>, blockInstanceId?: string): Promise<void>;
  load(sessionId: string, key: string, blockInstanceId?: string): Promise<unknown>;
  loadScope(sessionId: string, blockInstanceId?: string): Promise<Record<string, unknown>>;
  remove(sessionId: string, key: string, blockInstanceId?: string): Promise<void>;
