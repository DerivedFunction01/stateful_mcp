...
const TABLES = {
	...
	DDL_DICT_FILTERS: {
		...
		columns: [
			...
			{ name: "source_revision", type: "text", nullable: true },
	...
	DDL_DICT_SOURCES: {
		...
		columns: [
			...
			{ name: "capabilities", type: "json", nullable: true },
			{ name: "active", type: "bool", nullable: false, default: 1 },
		],
	},
	DDL_DICT_SYNC_STATE: {
		table: "dict_sync_state",
		ifNotExists: true,
		columns: [
			{ name: "projection_id", type: "text", nullable: false },
			{ name: "source_id", type: "text", nullable: false },
			{ name: "domain", type: "text", nullable: false },
			{ name: "cursor", type: "text", nullable: true },
			{ name: "high_water_mark", type: "text", nullable: true },
			{ name: "last_successful_sync", type: "text", nullable: true },
			{ name: "last_attempted_sync", type: "text", nullable: true },
			{ name: "freshness_deadline", type: "text", nullable: true },
			{ name: "status", type: "text", nullable: false },
			{ name: "error_message", type: "text", nullable: true },
		],
		primaryKey: ["projection_id", "source_id", "domain"],
	},
	DDL_DICT_TOMBSTONES: {
		table: "dict_tombstones",
		ifNotExists: true,
		columns: [
			{ name: "source_id", type: "text", nullable: false },
			{ name: "domain", type: "text", nullable: false },
			...
			{ name: "source_revision", type: "text", nullable: true },
			{ name: "deleted_at", type: "text", nullable: false },
		],
		primaryKey: ["source_id", "domain", "record_id"],
	},
	DDL_TRACES: {
		table: "traces",
		ifNotExists: true,
...
const INDEXES = {
	...
	IDX_DICT_EXPRESSION_LOOKUP: {
		table: "dict_custom_expressions",
		name: "idx_dict_expression_lookup_scope",
		columns: ["lookup_term", "scope_level", "scope_id"],
	},
	IDX_DICT_EXPRESSION_CONCEPT: {
		table: "dict_custom_expressions",
		name: "idx_dict_expression_concept",
		columns: ["concept_id"],
	},
	IDX_DICT_FILTER_CONCEPT_ROLE: {
		table: "concept_filters",
		name: "idx_dict_filter_concept_role",
		columns: ["concept_id", "role_name", "active"],
	},
	IDX_DICT_FILTER_ROLE: {
		table: "concept_filters",
		name: "idx_dict_filter_role",
		columns: ["role_name", "active"],
	},
	IDX_FORMS_SESSION: {
		table: "forms",
