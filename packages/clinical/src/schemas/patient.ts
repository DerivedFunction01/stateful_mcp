...
export type AdministrativeGender = "male" | "female" | "undetermined" | "not_applicable";

export type SubjectLifecycleStatus = "active" | "deceased" | "inactive_archived";
...
export interface PlantSubjectAttributes {
  propagationMethod: "seed_sexual" | "vegetative_clone" | "tissue_culture" | "grafting" | "unknown";
  geneticModificationStatus: "wild_type" | "selectively_bred" | "gmo" | "crispr_edited";
  cultivationEnvironment: "open_field" | "greenhouse" | "hydroponic" | "aeroponic" | "wild";
}
