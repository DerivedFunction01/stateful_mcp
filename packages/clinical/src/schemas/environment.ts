...
export type CoordinateDatum = "WGS84" | "NAD83" | "ETRS89" | "GRS80" | "MGRS" | "ED50" | "ICRS" | "MARS_IAU2000";
...
export type CombatEngagementLevel = "peaceful" | "low_tension" | "contested" | "active_combat" | "evacuation";

export type EmploymentRegime = "civilian_industrial" | "military_operational" | "first_responder" | "service_animal";

export type ErgonomicModality = "sedentary" | "manual_lifting" | "heavy_machinery" | "tactical_patrol" | "flight" | "diving";

export type TerrestrialTerrain = "forest" | "desert" | "mountainous" | "tundra" | "grassland" | "wetland" | "cave" | "urban" | "agricultural";
export type AquaticTerrain = "ocean" | "freshwater" | "coastal" | "submerged_reef";
export type AtmosphericTerrain = "troposphere" | "stratosphere" | "mesosphere_ionosphere";
export type CelestialSpaceTerrain = "low_earth_orbit" | "lunar_surface" | "martian_surface" | "deep_space";
...
export interface BaseEnvironmentContext {
  ...
  contextType: "geopolitical" | "coordinates" | "weather" | "combat_status" | "occupational_activity" | "structural_terrain" | "vehicle";
...
export interface LandTerrainContext extends BaseTerrainContext {
  ...
  buildingType?: "residential" | "office" | "school" | "industrial" | "medical" | "military" | "fortified" | "none";
...
export type StructuralTerrainContext = LandTerrainContext | WaterTerrainContext | AirTerrainContext | SpaceTerrainContext;
...
export interface VehicleContext extends BaseEnvironmentContext {
  ...
  controlModality: "human_occupied" | "remotely_operated" | "autonomous" | "semi_autonomous";
