...
export function createTemporalSyntaxProfile(
	...
	return {
		..._TEMPORAL_SYNTAX_DEFAULTS,
		...profile,
		dateRecognitionRules:
			profile.dateRecognitionRules ??
			_TEMPORAL_SYNTAX_DEFAULTS.dateRecognitionRules,
		relativeDayAliases: {
			..._TEMPORAL_SYNTAX_DEFAULTS.relativeDayAliases,
			...profile.relativeDayAliases,
		},
		unitAliases: {
			..._TEMPORAL_SYNTAX_DEFAULTS.unitAliases,
			...profile.unitAliases,
		},
		directionAliases: {
			..._TEMPORAL_SYNTAX_DEFAULTS.directionAliases,
			...profile.directionAliases,
		},
		rangeDelimiters:
			profile.rangeDelimiters ?? _TEMPORAL_SYNTAX_DEFAULTS.rangeDelimiters,
		boundaryAliases: {
			..._TEMPORAL_SYNTAX_DEFAULTS.boundaryAliases,
