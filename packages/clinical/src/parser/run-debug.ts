...
get: async (conceptId: string) => ({ conceptId, display: conceptId, namespaces: [] }),
...
{ targetField: "duration", targetValue: { magnitude: 3, unit: "day" }, regexPatterns: ["3 days ago"] },
{ targetField: "severityScore", targetValue: { score: 8, maxScore: 10 }, regexPatterns: ["8/10"] },
] as any;
