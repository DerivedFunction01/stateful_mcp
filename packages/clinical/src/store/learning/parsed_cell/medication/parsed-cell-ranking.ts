import type { ParsedCellMedicationDetail } from "../../interfaces";
import type {
...
export class MedicationPreferenceRanker
	implements ParsedCellRanker<ParsedCellMedicationDetail>
{
	score(
		candidate: ParsedCellMedicationDetail,
	...
	choose(
		deterministic: ParsedCellMedicationDetail | null,
		learned: ParsedCellMedicationDetail | null,
		context: ParsedCellRankerContext,
		mode: ParsedCellPreferenceMode = "dual",
	): ParsedCellPreferenceProjection<ParsedCellMedicationDetail> {
		...
		let winner: ParsedCellMedicationDetail | null = null;
	...
	rankMany(
		...
		context: ParsedCellRankerContext,
		mode: ParsedCellPreferenceMode = "dual",
	): ParsedCellPreferenceRanking<ParsedCellMedicationDetail> {
	...
	previewMany(
		...
		context: ParsedCellRankerContext,
		mode: ParsedCellPreferenceMode = "dual",
	): ParsedCellPreview<ParsedCellMedicationDetail> {
