...
export const numericSettingsModule: SettingsModule<Partial<NumericParseOptions>> =
	{
		id: "values.numeric",
		category: "values",
		group: "Numerics",
		...
		getSchema(i18n?: I18nKernel): readonly SettingsSchemaEntry[] {
			return [
				{
					path: ["values", "numeric", "decimalPoint"],
					type: "enum",
					widget: "dropdown",
					category: "values",
					group: "Numerics",
					title: translate(
						i18n,
						"settings.schema.values.numeric.decimalPoint.title",
					),
