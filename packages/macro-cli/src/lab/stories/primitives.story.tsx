...
const TREE_NODES: readonly TuiTreeNode[] = [
	{
		...
		children: [
			{
				id: "c1",
				label: 'Cell 1: ^echo message="hi"',
				variant: "supporting",
				meta: "[valid]",
			},
			{
				id: "c2",
				label: "Cell 2: ^deploy env=staging",
				variant: "supporting",
				meta: "[valid]",
			},
			{
				id: "c3",
				label: "Cell 3: raw text",
				variant: "refuting",
				meta: "[syntax-error]",
			},
		],
...
export const primitivesStory: TuiStory = {
	...
	render(context) {
		...
		const width = Math.max(40, Math.min(120, context.size.columns - 4));
		const theme = GlobalThemeRegistry.getActive();
		const c = theme.colors;
		const i18n =
			stateId === "status-badges-spanish" ? mockWsEs.workspace.i18n : undefined;

		// 1. STATUS BADGES & GLYPH VARIANTS (ENGLISH / SPANISH)
		if (
			stateId === "status-badges-and-glyphs" ||
			stateId === "status-badges-spanish"
		) {
			return (
				<TuiFrame
					title={
						stateId === "status-badges-spanish"
							? "Insignias de Estado (Español i18n)"
				...
				>
					<box flexDirection="column" padding={1}>
						...
						<TuiDivider
							label="1. Compact Solid Chips without Words (variant='solid-glyph')"
							theme={theme}
						/>
						<box
							flexDirection="row"
						...
						<TuiDivider
							label="2. Solid Pill Caps (variant='solid-pill')"
							theme={theme}
						/>
						<box
							flexDirection="row"
						...
						<TuiDivider
							label="3. Ultra-Compact Glyphs (variant='glyph-only')"
							theme={theme}
						/>
						<box
							flexDirection="row"
						...
						<TuiDivider
							label="4. Bracketed Glyphs (variant='bracket-glyph')"
							theme={theme}
						/>
						<box
							flexDirection="row"
						...
						<TuiDivider
							label="5. Icon & Localized Label (variant='icon-label')"
							theme={theme}
						/>
						<box
							flexDirection="row"
						...
						<TuiDivider
							label="6. Glowing Dot Indicator (variant='dot-label')"
							theme={theme}
						/>
						<box
							flexDirection="row"
						...
						<TuiDivider
							label="7. Solid Background Chips with Text (variant='solid-chip')"
							theme={theme}
						/>
						<box
							flexDirection="row"
		...
		if (stateId === "toggles-and-switches") {
			return (
				<TuiFrame
					title="Toggles, Switches, Checkboxes & Radios"
					width={width}
					showBounds={context.showBounds}
					theme={theme}
				>
					<box flexDirection="column" padding={1}>
						...
						<TuiDivider
							label="Checkboxes & Indeterminate States"
							theme={theme}
						/>
						...
						<box marginTop={1}>
							<TuiRadioGroup
								...
								options={[
									{
										id: "local",
										label: "Local Runtime (V8 isolates)",
										meta: "[default]",
									},
									{
										id: "sandbox",
										label: "Docker MicroVM Sandbox",
										meta: "[isolated]",
									},
									{
										id: "cloud",
										label: "Remote Kubernetes Cluster",
										meta: "[us-east-1]",
									},
								]}
								selectedId="local"
			...
			return (
				...
				>
					<box flexDirection="column" padding={1}>
						...
						<TuiDivider
							label="Range Sliders (Dual-Thumb Window)"
							theme={theme}
						/>
						<box flexDirection="column" marginTop={1}>
							<TuiRangeSlider
								label="Latency SLA Window"
								range={[20, 80]}
								unit="ms"
								isFocused={true}
								theme={theme}
		...
		if (stateId === "tag-chips-and-stepper") {
			return (
				<TuiFrame
					title="Tag Chips, Breadcrumbs & Steppers"
					width={width}
					showBounds={context.showBounds}
					theme={theme}
				>
		...
		if (stateId === "cell-navigation") {
			return (
				<TuiFrame
					title="2D Table Cell Navigation (hjkl / Arrow Keys)"
					width={width}
					showBounds={context.showBounds}
					theme={theme}
				>
					<box flexDirection="column" padding={1}>
						...
						<TuiDivider
							label="Modern IDE Table with 2D Cell Focus"
							theme={theme}
						/>
						<box marginTop={1}>
							<TuiTable
		...
		if (stateId === "tables-and-themes") {
			return (
				<TuiFrame
					title="Data Tables & Multi-Theme Layouts"
					width={width}
					showBounds={context.showBounds}
					theme={theme}
				>
					<box flexDirection="column" padding={1}>
						<TuiDivider
							label="Office Grid / Excel Box-Drawing Theme"
							theme={theme}
						/>
						<box marginTop={1} marginBottom={1}>
							<TuiTable
						...
						<TuiDivider
							label="Modern IDE Theme with Focus Pillar"
							theme={theme}
						/>
						<box marginTop={1} marginBottom={1}>
							<TuiTable
			...
			return (
				...
				>
					<box flexDirection="column" padding={1}>
						...
						<TuiDivider
							label="Card Outlines (Border on Idle → Solid Fill on Active)"
							theme={theme}
						/>
						<box flexDirection="column" marginTop={1} marginBottom={1}>
							<TuiButton
								label="Macro Scratchpad"
						...
						<TuiDivider
							label="Semantic Intents: Danger / Success / Warning"
							theme={theme}
						/>
						<box flexDirection="column" marginTop={1} marginBottom={1}>
		...
		if (
			stateId === "charts-and-distributions" ||
			stateId === "charts-and-metrics"
		) {
			return (
				<TuiFrame
					title="Charts, Distributions & Metrics"
					width={width}
					showBounds={context.showBounds}
					theme={theme}
				>
					<box flexDirection="column" padding={1}>
						<TuiDivider
							label="Stacked Memory / Resource Allocation"
							theme={theme}
						/>
						<box marginTop={1} marginBottom={1}>
							<TuiStackedBarChart
								items={MEMORY_STACKED_DATA}
								totalWidth={30}
								theme={theme}
							/>
						</box>
						...
						<TuiDivider
							label="Box & Whiskers (Min · Q1 · Med · Q3 · Max)"
							theme={theme}
						/>
						<box marginTop={1} marginBottom={1}>
			...
			return (
				...
				>
					<box flexDirection="column" padding={1}>
						...
						<box flexDirection="column" marginTop={1} marginBottom={1}>
							<TuiProgressBar
								label="Downloading language model weights"
								value={68}
								width={42}
								variant="continuous"
								theme={theme}
							...
							<box height={1} />
							<TuiProgressBar
								label="Compiling runtime AST schemas"
								value={100}
								width={42}
								intent="success"
								variant="continuous"
