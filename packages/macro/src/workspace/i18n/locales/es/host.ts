export const ES_HOST: Record<string, string> = {
	...
	"host.workspace.extensionUnlisted": "La extensión '{extensionId}' no aparece en el manifiesto del espacio de trabajo.",
	"host.workspace.extensionVersionMismatch": "La extensión '{extensionId}' tiene la versión {actual}; se esperaba {expected}.",
	"host.workspace.dependencyUnlisted": "La extensión '{extensionId}' requiere la dependencia no listada '{dependency}'.",
};
